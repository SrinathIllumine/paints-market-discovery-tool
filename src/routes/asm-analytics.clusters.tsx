...
export const Route = createFileRoute("/asm-analytics/clusters")({
  head: () => ({
    meta: [
      { title: "Cluster-wise Market Overview — ASM Analytics" },
      { name: "description", content: "Top clusters by revenue potential in my territory." },
    ],
  }),
  component: AsmClustersOverviewPage,
});

const PAGE_SIZE = 10;

function AsmClustersOverviewPage() {
  const geo = useAsmGeo();
  ...
  return (
    <AsmLayout>
      <div className="mb-4 flex flex-wrap items-center justify-between gap-3">
        <Link to="/asm-analytics" className="inline-flex items-center gap-1.5 text-sm font-medium text-navy hover:underline">
