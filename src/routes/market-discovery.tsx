...
import { Home, Map as MapIcon, Users, Lightbulb, ArrowRight, History } from "lucide-react";
...
export const Route = createFileRoute("/market-discovery")({
  head: () => ({
    meta: [
...
function IntroScreen() {
  ...
  const props: CardDef[] = [
    ...
    {
      icon: Users,
      title: "Create Market Engagement Plan for the Mapped Clusters",
        ...
        <div className="flex items-start justify-between gap-3">
          ...
          <div className="flex shrink-0 items-center gap-2">
            <Link
              ...
              title="Home"
              className="flex h-9 w-9 items-center justify-center rounded-full text-navy-foreground/80 hover:bg-white/10"
            >
            ...
            <Link
              ...
              title="My Dashboard"
              className="flex h-11 w-11 items-center justify-center rounded-full bg-critical text-sm font-semibold text-white shadow-md ring-2 ring-white/20 transition-transform hover:scale-105"
            >
              SK
            </Link>
          </div>
