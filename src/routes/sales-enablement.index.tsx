...
function SalesEnablementLanding() {
  ...
  return (
    ...
    >
      <p className="mx-6 mt-4 rounded-xl bg-white/5 px-4 py-3 text-sm text-navy border border-navy/10">
        Pick a cluster from your monthly plan to manage its funnel.
      </p>
