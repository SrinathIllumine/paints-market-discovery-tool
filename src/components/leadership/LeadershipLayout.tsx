...
/** Plain, uncolored pill for a cluster's quadrant type (e.g. "High Access – High Potential"). */
export function QuadrantTypeBadge({ quadrant, className }: { quadrant: QuadrantKey; className?: string }) {
  return (
    <span
      className={cn(
        "inline-block whitespace-nowrap rounded-full bg-slate-100 px-2.5 py-1 text-[11px] font-semibold text-slate-700",
        className,
      )}
    >
